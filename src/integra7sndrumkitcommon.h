...
#ifndef INTEGRA7SNDRUMKITCOMMON_H
#define INTEGRA7SNDRUMKITCOMMON_H

#include <QObject>
#include "integra7parameterset.h"

class Integra7SNDrumKitCommon : public Integra7ParameterSet
{
    Q_OBJECT
public:
...
#endif // INTEGRA7SNDRUMKITCOMMON_H
