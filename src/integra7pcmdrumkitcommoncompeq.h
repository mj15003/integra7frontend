...
#ifndef INTEGRA7PCMDRUMKITCOMMONCOMPEQ_H
#define INTEGRA7PCMDRUMKITCOMMONCOMPEQ_H

#include <QObject>
#include "integra7parameterset.h"

class Integra7PCMDrumKitCommonCompEQ : public Integra7ParameterSet
{
    Q_OBJECT
public:
    explicit Integra7PCMDrumKitCommonCompEQ(Integra7Device *parent, uint8_t o1, uint8_t o2, uint8_t o3);
    ...
    int getEQ1LowGain() {return data[0x08];}
    int getEQ1MidFreq() {return data[0x09];}
    int getEQ1MidGain() {return data[0x0A];}
    int getEQ1MidQ() {return data[0x0B];}
    int getEQ1HighFreq() {return data[0x0C];}
    int getEQ1HighGain() {return data[0x0D];}
    ...
    int getEQ2LowGain() {return data[0x16];}
    int getEQ2MidFreq() {return data[0x17];}
    int getEQ2MidGain() {return data[0x18];}
    int getEQ2MidQ() {return data[0x19];}
    int getEQ2HighFreq() {return data[0x1A];}
    int getEQ2HighGain() {return data[0x1B];}
    ...
    int getEQ3LowGain() {return data[0x24];}
    int getEQ3MidFreq() {return data[0x25];}
    int getEQ3MidGain() {return data[0x26];}
    int getEQ3MidQ() {return data[0x27];}
    int getEQ3HighFreq() {return data[0x28];}
    int getEQ3HighGain() {return data[0x29];}
    ...
    int getEQ4LowGain() {return data[0x32];}
    int getEQ4MidFreq() {return data[0x33];}
    int getEQ4MidGain() {return data[0x34];}
    int getEQ4MidQ() {return data[0x35];}
    int getEQ4HighFreq() {return data[0x36];}
    int getEQ4HighGain() {return data[0x37];}
    ...
    int getEQ5LowGain() {return data[0x40];}
    int getEQ5MidFreq() {return data[0x41];}
    int getEQ5MidGain() {return data[0x42];}
    int getEQ5MidQ() {return data[0x43];}
    int getEQ5HighFreq() {return data[0x44];}
    int getEQ5HighGain() {return data[0x45];}
    ...
    int getEQ6LowGain() {return data[0x4E];}
    int getEQ6MidFreq() {return data[0x4F];}
    int getEQ6MidGain() {return data[0x50];}
    int getEQ6MidQ() {return data[0x51];}
    int getEQ6HighFreq() {return data[0x52];}
    int getEQ6HighGain() {return data[0x53];}
...
#endif // INTEGRA7PCMDRUMKITCOMMONCOMPEQ_H
