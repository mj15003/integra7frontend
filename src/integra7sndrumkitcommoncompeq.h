...
#ifndef INTEGRA7SNDRUMKITCOMMONCOMPEQ_H
#define INTEGRA7SNDRUMKITCOMMONCOMPEQ_H

#include <QObject>
#include "integra7parameterset.h"

class Integra7SNDrumKitCommonCompEQ : public Integra7ParameterSet
{
    Q_OBJECT
public:
    Integra7SNDrumKitCommonCompEQ(Integra7Device *parent, uint8_t o1, uint8_t o2, uint8_t o3);
...
#endif // INTEGRA7SNDRUMKITCOMMONCOMPEQ_H
